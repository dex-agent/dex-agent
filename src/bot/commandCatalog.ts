export interface CommandSpec {
  ...
  description: string;
  usage: string;
  group: "Projeto" | "Execucao" | "Fila" | "Estado" | "Integracoes";
}
...
export const COMMAND_CATALOG: CommandSpec[] = [
  ...
  {
    command: "project",
    description: "Mostra o card do projeto atual",
    usage:
      "/project [default|executive|next|sources|steps|commands|prompts|queue]",
    group: "Projeto"
  },
  {
    command: "admin",
  ...
  },
  {
    ...
    usage:
      "/prompts [show|help|add <label> :: <prompt>|add <intent> :: <label> :: <prompt>|run <selector>|remove <selector>]",
    group: "Projeto"
  },
  {
    command: "inbox",
    description: "Revisa candidatos e propostas duraveis da memoria",
    usage:
      "/inbox [show|help|candidates|proposals|promote <id|index>|discard <id|index>|why <id|index>|confirm <id|index>|cancel <id|index>]",
    group: "Projeto"
  },
  {
    command: "memory",
    description: "Mostra memoria, candidatos, ajuda e promocoes do projeto",
    usage:
      "/memory [show|help|candidates|promote <id|index>|discard <id|index>|why <id|index>|remember <text>]",
    group: "Projeto"
  },
  {
    command: "remember",
    description:
      "Atalho curto para criar uma memoria candidata com proposta pronta",
    usage: "/remember <text>",
    group: "Projeto"
  },
  {
    command: "refinar",
    description:
      "Abre o trilho guiado para refinar captura solta antes de promover",
    usage: "/refinar <text>",
    group: "Projeto"
  },
  {
    command: "repo",
    description: "Lista ou troca de projeto",
    usage: "/repo [nome|recent|-]",
    group: "Projeto"
  },
  {
    command: "pwd",
    description: "Mostra o projeto atual",
    usage: "/pwd",
    group: "Projeto"
  },
  {
    command: "new",
    description: "Reinicia o contexto do projeto atual",
    usage: "/new",
    group: "Projeto"
  },
  {
    command: "queue",
    description: "Gerencia a fila do chat",
    usage:
      "/queue [list|add <task>|add <projeto> :: <task>|remove <id|index>|clear|run]",
    group: "Fila"
  },
  {
    command: "continue",
    description: "Continua pedido bloqueado por conflito de projeto",
    usage: "/continue",
    group: "Fila"
  },
  {
  ...
  {
    command: "auto",
    description: "Executa uma tarefa unica em modo auto",
    usage: "/auto <task>",
    group: "Execucao"
  },
  {
  ...
  {
    command: "interrupt",
    description: "Interrompe a execucao atual",
    usage: "/interrupt",
    group: "Execucao"
  },
  {
    command: "stop",
    description: "Encerra a sessao atual",
    usage: "/stop",
    group: "Execucao"
  },
  {
    command: "status",
    description: "Mostra o estado do bot neste chat",
    usage: "/status",
    group: "Estado"
  },
  {
    command: "dev",
    description: "Controla o servidor de dev do projeto",
    usage: "/dev [status|start|stop|logs|url]",
    group: "Estado"
  },
  {
    command: "model",
  ...
  {
    command: "language",
    description: "Troca o idioma do bot",
    usage: "/language [pt-BR|en|zh|zh-HK]",
    group: "Estado"
  },
  {
    command: "verbose",
    description: "Liga ou desliga avisos do sistema",
    usage: "/verbose [on|off]",
    group: "Estado"
  },
  {
    command: "gh",
    description: "Acoes explicitas do GitHub",
    usage: "/gh ...",
    group: "Integracoes"
  },
  {
    command: "mcp",
    description: "Acoes explicitas de MCP",
    usage: "/mcp ...",
    group: "Integracoes"
  },
  {
    command: "sh",
    description: "Executa shell segura",
    usage: "/sh <command>",
    group: "Integracoes"
  },
  {
    command: "cron_now",
    description: "Dispara o resumo diario agora",
    usage: "/cron_now",
    group: "Integracoes"
  },
  {
  ...
  {
    command: "help",
    description: "Mostra a ajuda completa",
    usage: "/help",
    group: "Integracoes"
  }
];
