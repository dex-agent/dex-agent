...
- `skills/dex-pai/SKILL.md` e espelho fiel da skill global canonica para encaminhar achados de repos filhos ao Dex Agent pai configurado por `TELEGRAM_EXPECTED_USERNAME`, com artefato local e envio por helper, sem depender de aba do Telegram Web
...
- `skills/dex-rede/SKILL.md` e a skill de roteamento entre projetos Dex Agent por alias (`alpha`, `beta`, `gamma`, `dex-pai`), usando helper por API e retornando `message_id`
...
- `skills/dex-install/SKILL.md` e a skill local de contrato para instalar o Dex Agent em novo projeto filho com bot dedicado, bootstrap local, registry de aliases e evidencia real; o guia operacional fica em `skills/dex-install/README.md` e o prompt pronto em `skills/dex-install/templates/install-prompt.md`
